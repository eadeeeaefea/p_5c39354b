    ...
    while (1) {
        ...
        if (1) {
            ...
            if (read_pack_.mode == Mode::ARMOR) {
                ...
                angle_solver.speedtriangle(target_.x, target_.y, target_.z, 20, send_pack_.yaw, send_pack_.pitch);

            } else if (read_pack_.mode == Mode::RUNE) {

                rune_solver.run(current_frame_, target_.x, target_.y, target_.z);
                angle_solver.speedtriangle(target_.x, target_.y, target_.z, 28, send_pack_.yaw, send_pack_.pitch);
