...
void Predictor::run(double &x, double &y, double &z, double ptz_pitch,
                    double ptz_yaw) {
...
void Predictor::motion_prediction(double &x, double &y, double &z,
...
void Predictor::explosive_motion_prediction(double &x, double &y, double &z,
                                            double ptz_pitch, double ptz_yaw) {
  double angle_pitch, angle_yaw;
  angle_pitch = ptz_pitch * PI / 180;
  angle_yaw = ptz_yaw * PI / 180;
...
void Predictor::normal_motion_prediction(double &x, double &y, double &z,
                                         double ptz_pitch, double ptz_yaw) {
  double angle_pitch, angle_yaw;
  angle_pitch = ptz_pitch * PI / 180;
  angle_yaw = ptz_yaw * PI / 180;
...
void Predictor::coordinate_transformation(double &x, double &y, double &z,
                                          double ptz_pitch, double ptz_yaw) {
  double absolute_x;
  double absolute_y;
  double absolute_z;
...
void Predictor::anti_coordinate_transformation(double &x, double &y, double &z,
                                               double ptz_pitch,
                                               double ptz_yaw) {
  double objective_x;
  double objective_y;
...
void Predictor::get_excercise_time(double x, double y, double v,
                                   double ptz_pitch) {
  double time_square;
