...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btn_exit->setGeometry(QRect(1150, 540, 101, 41));
        QFont font1;
        font1.setPointSize(15);
        btn_exit->setFont(font1);
        btn_freeze = new QPushButton(centralWidget);
        btn_freeze->setObjectName(QStringLiteral("btn_freeze"));
        btn_freeze->setGeometry(QRect(1020, 540, 101, 41));
        btn_freeze->setFont(font1);
        btn_clear = new QPushButton(centralWidget);
        btn_clear->setObjectName(QStringLiteral("btn_clear"));
        btn_clear->setGeometry(QRect(1020, 470, 101, 41));
        btn_clear->setFont(font1);
        btn_detail = new QPushButton(centralWidget);
        btn_detail->setObjectName(QStringLiteral("btn_detail"));
        btn_detail->setGeometry(QRect(1150, 470, 101, 41));
        btn_detail->setFont(font1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btn_detail->setText(QApplication::translate("MainWindow", "Detail", Q_NULLPTR));
